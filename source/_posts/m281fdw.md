...
1. [HP_LaserJet_Pro_M280_M281_Printer_series_20200612.exe](HP_LaserJet_Pro_M280_M281_Printer_series_20200612.exe)
...
## Windows双击法
在Windows系统中双击**HP_LaserJet_Pro_M280_M281_Printer_series_20200612.exe**并按照提示进行操作，可以参考[HP惠普M281打印机升级后不兼容国产硒鼓，系统固件降级步骤](https://post.smzdm.com/p/a0qkwegr/)，貌似需要用USB线连接电脑。

上述方法均未经本人验证，不过根据reddit上的回帖反馈，不少人用FTP方式刷机成功，将系统固件降级到了**20200612**。

# 其他
M281FDW开机启动出现能源之星图标时，按住屏幕左下角或右下角可以实现打印机重置，分别对应完全恢复出厂设置和在保留国家地区不变前提下清空其他设置。
